/*
 * Plutonium React-State-Animator v1.0.7
 ...
 * Released under the MIT license
*/
exports.animator = function(plugins) {
	...
	function _frames(animation) {
		...
		t.changeDuration = function(newDuration, curDuration) {
		...
		t.getFrame = function(timestamp, skipPlay) {
...
exports.morph = function(animator) {
